...
export function LeaderSection() {
  return (
    <section id="leader" className="snap-section sec-bg-alt">
      <div className="inner">
        <p data-reveal className="text-sm font-bold text-[#D4AF77] tracking-widest mb-3">LEADER</p>
        <h2 data-reveal data-reveal-delay="60" className="text-3xl md:text-4xl font-bold text-[#0A2540] mb-3 break-keep">
