  ...
  return (
    <section id="hero" className="snap-section-hero relative overflow-hidden">
      ...
      <div className="inner relative z-10 text-center pt-20">
        ...
        <h1 className="hero-item text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 text-white tracking-tight break-keep" style={{ animationDelay: "100ms" }}>
